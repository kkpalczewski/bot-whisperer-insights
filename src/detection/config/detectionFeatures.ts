...
export const features: DetectionFeature[] = Object.values(modules).flatMap(
  (content) => {
    try {
            ...
            const processOutputs = (
              ...
              for (const [key, value] of Object.entries(outputs)) {
                ...
                processed[key] = {
                  ...
                  abuse_indication:
                    value.abuse_indication || feature.abuse_indication || {},
                  // Ensure type exists
                  type: value.type || "string",
                  // Ensure exemplary_values exists
                  exemplary_values:
                    value.exemplary_values || feature.exemplary_values || [],
                  // Recursively process any nested outputs
                  outputs: value.outputs
                    ? processOutputs(value.outputs, fullKey)
                    : undefined,
                };
              }
